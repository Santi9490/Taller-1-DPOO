...
public class ConsolaOlimpicos
{
	...
	/**
	 * Le muestra al usuario el país del atleta ingresado
	 */
	...
	private void ejecutarPaisAtleta()
	{
		...
		if (pais == null) {
			System.out.println("No se encontro un Atleta con ese nombre");
	    }
		else {
			System.out.println("El país del atleta " + nombre + " es: " + pais);
		}
	}
